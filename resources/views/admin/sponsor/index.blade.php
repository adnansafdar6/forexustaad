                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('admin.sponsor.edit', 0) }}"><button class="btn btn-outline-success">Add Sponsor</button></a>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="width-15">
                                                    ...
                                                    @if($value->is_active == 1)
                                                        <a class="pr-2" href="{{ route('admin.sponsor.changeStatus', $value->id) }}"
                                                           title="De Active"><i class="fa-solid fa-thumbs-up"></i></a>
                                                @else
                                                        <a class="pr-2" href="{{ route('admin.sponsor.changeStatus', $value->id) }}"
                                                           title="Active"><i class="fa-solid fa-thumbs-down" style="color: #ff3300;"></i></a>
                                                @endif
                                                <a class="pr-2" href="{{ route('admin.sponsor.edit', $value->id) }}"
                                                   title="Edit"><i class="fa-solid fa-pen-to-square" style="color: #68ee6a;"></i></a>
                                                <a href="javascript:{};" data-url="{{ route('admin.sponsor.destroy',  $value->id) }}" title="Delete" class="delete"><i class="fa-solid fa-trash" style="color: #ff0000;"></i></a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
