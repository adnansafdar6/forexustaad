                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{ route('admin.role.edit', 0) }}"><button class="btn btn-outline-success">Add New Role</button></a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="datatable table table-stripped" id="dataTable">
                                    ...
                                    @forelse($role as $key => $value)
                                        <tr>
                                            ...
                                            <td class="width-15">
                                                <a class="pr-2" href="{{ route('admin.role.edit', $value->id) }}"
                                                   title="Edit"><i class="fa-solid fa-pen-to-square" style="color: #68ee6a;"></i></a>
                                                <a href="javascript:{};" data-url="{{ route('admin.role.destroy',  $value->id) }}" title="Delete" class="delete"><i class="fa-solid fa-trash" style="color: #ff0000;"></i></a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
